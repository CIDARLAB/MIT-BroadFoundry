...
#---------------------------------------------------------------
    ...
    print time_axis_params
    for i in range(len(input_and_logic_gate_dictionaries)):
        print input_and_logic_gate_dictionaries[i]
    print input_and_logic_gate_names
    print logic_gate_names
...
#---------------------------------------------------------------
    ...
    for i in range(len(logic_gate_names)):
        #If a degredation constant alpha was not given, calculate it from the halflife
