...
def getmRNAChange(t,initmRNAVal,gateProperties,input_and_logic_gate_dictionaries,input_and_logic_gate_names,logic_gate_names,initProtein):
    ...
    #In case the gate type is not recognized.
        ...
        return
#    return mRNAChangeFinder(t,initmRNAVal,gateProperties,input_and_logic_gate_dictionaries,input_and_logic_gate_names,logic_gate_names,initProtein)
...
def activator(mB,Km,n,Input):
    ...
    try:
        ...
        try:
            ...
            return 0
def mRNAChangeFinder(t,initmRNAVal,gateProperties,input_and_logic_gate_dictionaries,input_and_logic_gate_names,logic_gate_names,initProtein):
    firstTerm = -gateProperties['am']*initmRNAVal    
