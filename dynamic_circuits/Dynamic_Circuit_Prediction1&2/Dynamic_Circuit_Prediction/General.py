...
Predicts protein concentrations for a given circuit given a set of inputs and 
functions describing how the inputs are applied. Uses takes into account both
mRNA and promoter production rates.
