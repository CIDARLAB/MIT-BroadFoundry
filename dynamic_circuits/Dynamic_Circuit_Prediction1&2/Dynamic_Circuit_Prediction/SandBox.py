...
def compareFiles(e):
    fileLoc1 = "C:\Users\Arinze\Documents\GitHub\MIT-BroadFoundry\dynamic_circuits\Dynamic_Circuit_Prediction\JsonFiles\TestCases/AZLResults1.json"

    fileLoc2 = "C:\Users\Arinze\Desktop\TestCases/Results1.json"

    myFile1 = open(fileLoc1,'r')

    myFile2 = open(fileLoc2,'r')
    data1 = json.load(myFile1)
    data2 = json.load(myFile2)
    print len(data1)
    print len(data2)
    myFile1 = open(fileLoc1,'r')
    myFile2 = open(fileLoc2,'r')
    ...
    while True:
        ...
        if line1==None or line1 == "":
            break
        try:
            num1 = round(float(line1[:-2]),15)
            num2 = round(float(line2[:-2]),15)
            if abs(num1-num2) > e:
                print num1
                print num2
                print count
