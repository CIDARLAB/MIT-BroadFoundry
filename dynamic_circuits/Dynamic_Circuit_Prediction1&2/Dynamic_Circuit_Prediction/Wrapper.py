...
inputsDir = "JsonFiles/Libraries/InputLibrary4.json"
repressorsDir = "JsonFiles/Libraries/RepressorLibrary4.json"
outputsDir = "JsonFiles/Libraries/OutputLibrary4.json"
...
def func(circuitString):
    ...
    """
    for i in range(1,10):
         inputsDir = "JsonFiles/Libraries/InputLibrary"+str(i)+".json"
         repressorsDir = "JsonFiles/Libraries/RepressorLibrary"+str(i)+".json"
         outputsDir = "JsonFiles/Libraries/OutputLibrary"+str(i)+".json"
         Libraries = [inputsDir, repressorsDir, outputsDir]
