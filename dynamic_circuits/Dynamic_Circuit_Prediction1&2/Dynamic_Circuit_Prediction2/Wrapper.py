...
@author: Arinze
"""
#This file is not nevessary for anything and probably doesn't work properly.
#import Graph
#import Gate
#import Wire
#import inputs
...
#    """
#    Takes in a netlist of circuit attributes and returns a graph created from 
#    that string, a list of all the gates in that graph, lists of the inputs,
...
#
#def makeGraphFromString(circuitString):
#    """
...
#    
#    #Make the graph with xMin of 0 and xMax of the period of the most significant
...
#        graph.addWire(wire) 
#    
#    return graph, allGates, Inputs, Repressors, Outputs
#    
...
#    graph, allGates, Inputs, Repressors, Outputs = makeGraphFromString(circuitString)
...
#placeToSaveRepressilator = "C:\Users\Arinze\SkyDrive\UROP_Summer_2015\NetlistsFromBryan/repressilatorGraph.json"
##
...
#placeToSaveTruthValueExample = "C:\Users\Arinze\SkyDrive\UROP_Summer_2015\NetlistsFromBryan/01101001Graph.json"
#
