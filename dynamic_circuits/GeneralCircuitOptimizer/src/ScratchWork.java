...
public class ScratchWork{
	public static void main(String[] args){
		...
		*/
		String aName = "(~(((~IN4).(IN1.IN2)).IN3.(IN2.IN4)))";
		String bName = "((((IN3.IN4).IN2).(IN3.IN4).IN4).(((IN3.IN4).IN2).(IN3.IN4).IN3))";
		String cName = "(~((~IN3).IN2.IN4))";
		String dName = "(~((((IN2.IN3).IN3.IN4).IN4).((IN2.IN3).IN2).(((IN2.IN3).IN3.IN4).IN3.(IN2.IN3))))";
		String eName = "(((~IN2).IN3).IN4)";
		String fName = "(~(((IN1.IN2).IN3).(IN3.IN4).((IN1.IN2).IN4)))";
		String gName = "(~(((~IN2).IN3).((~IN2).IN4).((IN1.IN3).IN2)))";
		Circuit a = new Circuit(aName,"0");
		Circuit b = new Circuit(bName,"0");
		Circuit c = new Circuit(cName,"0");
		Circuit d = new Circuit(dName,"0");
