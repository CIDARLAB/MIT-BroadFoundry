...
bsub -q forest -o ./logs/01_map_reads_N29.out.log -e ./logs/01_map_reads_N29.err.log "python $BIN_PATH/map_reads.py -settings ./data/settings.txt -samples N29"
bsub -q forest -o ./logs/01_map_reads_N30.out.log -e ./logs/01_map_reads_N30.err.log "python $BIN_PATH/map_reads.py -settings ./data/settings.txt -samples N30"
bsub -q forest -o ./logs/01_map_reads_N31.out.log -e ./logs/01_map_reads_N31.err.log "python $BIN_PATH/map_reads.py -settings ./data/settings.txt -samples N31"
