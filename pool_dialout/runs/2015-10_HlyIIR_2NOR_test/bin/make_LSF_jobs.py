...
run_prefix = home_prefix + 'runs/2015-10_HlyIIR_2NOR_test/'
...
run_data = {}
run_data['HlyIIR_2NOR'] = ['spl1_S1_L001_R1_001_test.fastq', 'spl1_S1_L001_R2_001_test.fastq', '20', '20', R1_fwd_bc_idx, R1_rev_bc_idx, other_bc_idxs]
