'''
This sequence generator function is the source of all randomly generated sequences in PRO_Genie.  It allows the setting
of nucleotide percentages and tolerance for deviation from those percentages, length, and number of sequences.  
'''
