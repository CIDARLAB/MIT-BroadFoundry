'''
This function is part of the promoter analysis family of functions.  It calculates the nucleotide percentage of a 20bp
sliding window across an input sequence.  This output can be used to generate nucleotide content profiles for promoters.
'''
